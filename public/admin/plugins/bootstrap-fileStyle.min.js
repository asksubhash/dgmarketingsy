	...
	Filestyle.prototype = {
		...
		size: function (value) {
			if (value !== undefined) {
				...
				var btn = this.$elementFilestyle.find(
						'label'
					),
					input = this.$elementFilestyle.find(
						'input'
					);
		...
		constructor: function () {
			...
			btn =
				...
				'<label for="' +
				id +
				'" style="margin-bottom: 0; border-radius: 0px !important; background-color: #0ea443 !important; color:white;" class="btn ' +
