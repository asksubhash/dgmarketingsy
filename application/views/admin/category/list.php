			...
			<div class="box-header ui-sortable-handle">
				<div class="row">
					...
					<div class="col-sm-12 table-responsive">
								...
								<tbody class="category_data_tbody">
									...
									foreach ($category as $cat_data) : ?>
										<tr>
											<td width="100"><?= $i++ ?></td>
											<td width="100">
												<?php if ($cat_data['image'] !== '' && file_exists('./public/admin/uploads/category/' . $cat_data['image'])) : ?>
													<img src="<?= base_url() . 'public/admin/uploads/category/' . $cat_data['image']; ?>" width="50">
												<?php else : ?>
						...
						<!-- insert modal  -->
						<div class="modal fade" id="add-new-cat-modal">
